...
def calculate_price(number_of_tickets):
  # Create a new constant fot the 2 dollar service charge
  # Add the service charge to our result
  return (number_of_tickets * TICKET_PRICE) + SERVICE_CHARGE

# Run this code continuously until we ran out of tickets
while tickets_remaining >= 1:
  ...
  # Prompt the user by name and ask how maney tickets they would like
  ...
  try:
    ...
    if should_proceed.lower() == "y":
      ...
      # TODO: Gather credit card information and proces it.
      print("SOLD!")
      # and then decrement the tickets remaining by the number of tickets purchased
      tickets_remaining -= num_tickets
    # Otherwise...
    else:
      # Let's thank than by name
